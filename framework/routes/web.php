...
Route::group(['middleware' => ['installed_or_not', 'auth']], function () {
    ...
    Route::resource('admin/healthfacilitys', healthfacilityController::class);
    ...
    Route::get('healthfacility_breakdown', [BreakdownController::class,'ajax_healthfacility_change']);
    ...
    Route::get('healthfacility_preventive', [PreventiveController::class,'ajax_healthfacility_change']);
    ...
    Route::get('admin/reports/time_indicator/ajax_equipment_based_on_healthfacility', [ReportController::class,'ajax_to_get_equipment']);
