...
class ReminderController extends Controller {
	...
	// 	$index['preventive_reminder'] = CallEntry::query()->healthfacility()->where('call_type', 'preventive')
	...
	// 	$index['calibrations'] = Calibration::query()->healthfacility()->orderBy('due_date', 'asc')
	// 		->paginate(10);
	...
	{
		$index['page'] = 'preventive_maintenance_reminder';
		$index['preventive_reminder'] = CallEntry::query()->healthfacility()
	...
	{
		$index['page'] = 'calibrations_reminder';
		$index['calibrations'] = Calibration::query()->healthfacility()
