                ...
                <div class="box-body">
                    ...
                    <div class="row m-0">
                        <div class="form-group col-md-2">
                            ...
                            {!! Form::select('healthfacility', $healthfacilitys, $healthfacility ?? null, [
                                'class' => 'form-control healthfacility_select',
                                'placeholder' => 'Select',
                            ]) !!}
                        </div>
                                ...
                                @if (isset($call_entries) && $call_entries->count() > 0)
                                    ...
                                    @foreach ($call_entries as $entry)
                                        ...
                                        <tr>
                                            ...
                                            <td> {{ $entry->equipment->healthfacility->name ?? '-' }}</td>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            @if (request('healthfacility'))
                var healthfacility_id = {{ request('healthfacility') }}
                if (healthfacility_id) {
                    $.ajax({
                        url: "{{ url('admin/reports/time_indicator/ajax_equipment_based_on_healthfacility') }}",
                        method: 'get',
                        data: {
            ...
            $('.healthfacility_select').on('change', function() {
