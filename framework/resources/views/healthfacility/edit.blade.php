...
@endsection
@section('breadcrumb')
<li><a href="{{ url('admin/healthfacilitys') }}">@lang('equicare.healthfacilitys')</a></li>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box-header">
				<h4 class="box-title">@lang('equicare.edit_healthfacility')</h4>
				</div>
				<div class="box-body ">
					@include ('errors.list')
					<form class="form" method="post" action="{{ route('healthfacilitys.update',$healthfacility->id) }}">
						{{ csrf_field() }}
