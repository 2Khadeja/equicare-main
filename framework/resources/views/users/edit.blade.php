                ...
                <div class="box-body ">
                    ...
                    <form class="form" method="post" action="{{ route('users.update', $user->id) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="healthfacilitys"> @lang('equicare.healthfacilitys')
                                    @if ($user->select_all == 1)
                                        <span class="select_all_msg">(Select All option automatically assigns a new healthfacility
                                            to a user.)</span>
                                    @else
                                ...
                                <select class="select2_healthfacility form-control" multiple name="healthfacilitys[]">
                                    ...
                                    @foreach ($healthfacilitys as $healthfacility)
                                        <option value="{{ $healthfacility->id }}"
                                            @if (in_array((int) $healthfacility->id, $selectedhealthfacilityIds)) selected @endif>
                                            {{ $healthfacility->name ?? '' }}
                                        </option>
                                    @endforeach
